...
original = pd.read_csv('output_6.csv')
oorzaken = data['cause_nl'].tolist()
for x in oorzaken:
    data = original.loc[original['cause_nl'] == x]
    ...
    plt.savefig('goedeAfbeeldingen/' + x + 'aantpermaand.png')
    ...
    plt.savefig('goedeAfbeeldingen/' + x + 'minpermaand.png')
    plt.rcParams.update(plt.rcParamsDefault)
    plt.clf()
    ...
    plt.savefig('goedeAfbeeldingen/' + x + 'aantperuur.png')
    plt.rcParams.update(plt.rcParamsDefault)
    plt.clf()
    ...
    plt.savefig('goedeAfbeeldingen/' + x + 'minperuur.png')
    plt.rcParams.update(plt.rcParamsDefault)
    plt.clf()
